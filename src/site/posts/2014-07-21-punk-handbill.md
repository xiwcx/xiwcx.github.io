...
In sci-fi movies animated advertisements are loud and obnoxious, but I wanted to try a subtler effect for my first attempt at this technique. It took a good amount of guessing and checking, but thanks to [codepen](http://codepen.io/xiwcx/pen/pEgHD?editors=110) (where you can check out the unminified, unprocessed code) that process was made much quicker. The layering of the transparent antlers being both &#8220;above&#8221; and &#8220;below&#8221; the color pulsating band names was something that came out of this process too.
